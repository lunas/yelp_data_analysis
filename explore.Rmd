...
4. If there is a correlation between new rating and average of hitherto ratings, then the first explanation of course is the characteristics of the business (say a 'good' business will attract high ratings, both in the average an for the new one). To distinguish those two factors, only correlation the new rating with an average of a window of the last L ratings (say L=10)
