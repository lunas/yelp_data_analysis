...
There are though a couple of problems that with this Ordered Logit Regression:
...
One should keep in mind though, that this data is purely 'correlational', not causal.
